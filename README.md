...
| 날짜 | 내용 |
|---|---|
| [2026-09-09 (수)](2026-09/09-09/README.md) | PowerShell 기초, 시스템 점검, 배경화면 변경 |
| [2026-09-10 (목)](2026-09/09-10/README.md) | 네트워크와 URL, JSON·XML, 공공데이터 API |
| [2026-09-11 (금)](2026-09/09-11/README.md) | HTML·CSS, 얼굴 랜드마크, 눈 불꽃 이미지 합성 |
